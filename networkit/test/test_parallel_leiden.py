...
def test_parallel_leiden_algorithm(graph):
    ...
    try:
        ...
        leiden = nk.community.ParallelLeidenView(graph, iterations=3, randomize=True, gamma=1.0)
        ...
        print(f"Modularity: {nk.community.Modularity().getQuality(partition, graph):.6f}")
